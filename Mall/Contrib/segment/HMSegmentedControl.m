...
//        CGFloat y = ((self.height - self.selectionIndicatorHeight) / 2) + (self.selectionIndicatorHeight - stringHeight / 2);
        CGRect rect = CGRectMake(self.segmentWidth * idx, 0.0f, self.segmentWidth, stringHeight);
...
//        return CGRectMake(x, 32.0f, self.frame.size.width / self.sectionTitles.count, self.selectionIndicatorHeight);
        return CGRectMake(self.segmentWidth * self.selectedIndex, 32.0f, self.frame.size.width / self.sectionTitles.count, self.selectionIndicatorHeight);
    } else {
        return CGRectMake(self.segmentWidth * self.selectedIndex, 32.0f, self.segmentWidth, self.selectionIndicatorHeight);
    }
}
